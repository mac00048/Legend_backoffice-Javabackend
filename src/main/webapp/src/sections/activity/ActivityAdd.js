...
class ActivityAdd extends Component {
    ...
    onFormSubmit(event) {
        ...
        activity.add(this.state.form)
            .then(json => {
                this.setState({ blocking: false }, () => this.props.history.push(`/activity`));
            })
            .catch(error => {
                this.setState({
                    error: true
                ...
                <div className="container">
                    ...
                    <form name="contact" method="POST" onSubmit={this.onFormSubmit}>
                        ...
                        <div className="field is-grouped">
                            <div className="control">
                                <button type="submit" className="button is-link">Add Activity</button>
                            </div>
                            <div className="control">
                                <button type="button" className="button is-light" onClick={() => this.props.history.push("/activity")}>Cancel</button>
                            </div>
                        </div>
                    </form>
