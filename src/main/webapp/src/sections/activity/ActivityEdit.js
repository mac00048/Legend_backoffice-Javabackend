...
class ActivityEdit extends Component {
        ...
        activity.get(this.state.id)
            .then(json => this.setState({
                ...
                form: {
                    ...
                    images: json.images.map((image) => { return { fileId: image.fileId, title: image.title } })
                },
                init: true
            }))
    ...
    onFormSubmit(event) {
        ...
        activity.edit(this.state.id, this.state.form)
            .then(json => {
                this.setState({ blocking: false }, () => this.props.history.push(`/activity/${this.state.id}`));
            })
            .catch(error => {
                this.setState({
                    error: true
                ...
                <div className="container">
                    ...
                    <form name="contact" method="POST" onSubmit={this.onFormSubmit}>
                        ...
                        <div className="field">
                            ...
                            <div className="control">
                                <input name="subtitle" className="input" type="text" value={this.state.form.subtitle} onChange={this.onFormChange}/>
                            </div>
                        </div>
                        <div className="field">
                        ...
                        <div className="field is-grouped">
                            ...
                            <div className="control">
                                <button type="button" className="button is-light" onClick={() => this.props.history.push(`/activity/${this.state.id}`)}>Cancel</button>
                            </div>
                        </div>
                    </form>
