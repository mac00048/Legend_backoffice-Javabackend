                    ...
                    <div id="navbarBasicExample" className={"navbar-menu" + menuToggle}>
                        <div className="navbar-end">
                            {this.data.items.map((item) =>
                                <NavLink key={item.href} to={item.href} onClick={this.onMenuEntryClick} className={ "navbar-item " + (location === item.href ? " is-active" : "") }>{item.title}</NavLink>
                            )}

                            <div className="navbar-item has-dropdown is-hoverable" style={{marginLeft: '20px'}}>
                                <a className="navbar-link" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                                    <span className="icon is-medium" style={{ marginRight: '4px' }}>
                                ...
                                <div className="navbar-dropdown is-right">
                                    ...
                                    */}
                                    <NavLink to='/logout' onClick={this.onMenuEntryClick} className="navbar-item">Logout</NavLink>
                                </div>
                            </div>
                        </div>
                    </div>
